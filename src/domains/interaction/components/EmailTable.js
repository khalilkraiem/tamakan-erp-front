...
import data from '../../../constants/smsData'
...
function EmailTable() {
    ...
    return (
        ...
        <div>
            <div className='br10 bgWhite row h70 Center'>
                <div className='mar10 w200 h30 cCenter bgGray br5'>
                    <p> Sent</p>
                </div>
                <div className='mar10 w200 h30 cCenter bgBlue white br5'>
                    <p> Inbox</p>
                </div>
            </div>
            <div className='fzm'>
                ...
                {data.map((elem, i) => (
                    <div key={i} className={`spaceBetween h50 ${i % 2 === 1 ? "bgWhite" : "bgLightGray "} line`}>
                        <div className='row'>
                            ...
                            <div className='w300 Center fzm'><p>{elem.title}</p></div>
                            <div className='w200 Center fzm'><p>{elem.to}</p></div>
                        </div>
                        <div className='w100 cCenter mar20'>
                            <div className='h20 w20 br5 bgLightOrange cCenter mar5 pointer' onClick={() => navigate("viewEmail")}>
