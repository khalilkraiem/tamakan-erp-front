...
import data from '../../../constants/requestsData'
...
function RequestTable({setViewRequestIsOpen,setDeleteRequestIsOpen}) {
            ...
            <div className='fzm'>
                <div className='spaceBetween h50 gray borderbGray '>
                    <div className='row'>
                        ...
                        <div className='w200 Center'><p>Requests Order</p></div>
                        <div className='w200 Center'><p>the Order</p></div>
                ...
                {data.map((elem, i) => (
                    <div key={i} className={`spaceBetween h50 ${i % 2 === 1 ? "bgWhite" : "bgLightGray "} line`}>
                        <div className='row'>
                            ...
                            <div className='w200 Center fzm'><p>{elem.requestOrder}</p></div>
                            <div className='w200 Center fzm'><p>{elem.theOrder}</p></div>
                            

                        </div>
                        <div className='w100 cCenter mar20'>

                            <div className='h20 w20 br5 bgLightOrange cCenter mar5 pointer' onClick={()=>setViewRequestIsOpen(true)}>
                            ...
                            <div className='h20 w20 br5 bgLightRed cCenter mar5 pointer' onClick={()=>setDeleteRequestIsOpen(true)} >
