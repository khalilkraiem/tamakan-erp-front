...
import data from '../../../constants/tasksData'
...
function TaskTable({setViewTaskIsOpen}) {
            ...
            <div className='fzm'>
                <div className='spaceBetween h50 gray borderbGray '>
                    <div className='row'>
                        ...
                        <div className='w200 Center'><p>Departement</p></div>
                        <div className='w200 Center'><p>Type od Requests</p></div>
                ...
                {data.map((elem, i) => (
                    <div key={i} className={`spaceBetween h50 ${i % 2 === 1 ? "bgWhite" : "bgLightGray "} line`}>
                        <div className='row'>
                            ...
                            <div className='w200 Center fzm'><p>{elem.departement}</p></div>
                            <div className='w200 Center fzm'><p>{elem.typfOfRequests}</p></div>
                            

                        </div>
                        <div className='w100 cCenter mar20'>

                            <div className='h20 w20 br5 bgLightOrange cCenter mar5 pointer' onClick={()=>setViewTaskIsOpen(true)}>
