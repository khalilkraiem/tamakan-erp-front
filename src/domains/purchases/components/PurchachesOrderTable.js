...
import data from '../../../constants/purchasesOrderData'
...
function PurchasesOrderTable({setViewOrderIsOpen,setEditOrderIsOpen}) {
            ...
            <div className='fzm'>
                <div className='spaceBetween h50 gray borderbGray '>
                    <div className='row'>
                        ...
                        <div className='w200 Center'><p>Employee name</p></div>
                        <div className='w200 Center'><p>Department</p></div>
                    </div>
                    <div className='cCenter w300 mar20'>
                ...
                {data.map((elem, i) => (
                    <div key={i} className={`spaceBetween h50 ${i % 2 === 1 ? "bgWhite" : "bgLightGray "} line`}>
                        <div className='row'>
                            <div className='w100 Center fzm mar20 '><p className='mar10'>{elem.number}</p></div>
                            <div className='w200 Center fzm'><p>{elem.employeeName}</p></div>
                            <div className='w200 Center fzm'><p>{elem.department}</p></div>
                          
                        </div>
                        <div className='w300 cCenter mar20'>

                            <div className='h20 w20 br5 bgLightOrange cCenter mar5 pointer' onClick={()=>setViewOrderIsOpen(true)}>
                                <img alt='eye' src={eye} className='' />
                            </div>


                            <div className='h20 w20 br5 bgLightBlue cCenter  pointer' onClick={()=>setEditOrderIsOpen(true)} >
