...
function RemindersTable({setAddReminderIsOpen,setDeleteReminderIsOpen}) {
  return (
                ...
                {data.map((elem, i) => (
                    <div key={i} className={`spaceBetween h50 ${i % 2 === 1 ? "bgWhite" : "bgLightGray "} line`}>
                        ...
                        <div className='w100 cCenter mar20'>
                            ...
                            <div className='h20 w20 br5 bgLightOrange cCenter mar5 pointer' onClick={()=>setAddReminderIsOpen(true)} >
