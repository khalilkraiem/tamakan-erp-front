        ...
        <div className='bgLightGray '>
            <div className='fzm'>
                <div className='spaceBetween h50 gray borderbGray '>
                    <div className='row'>
                        <div className='w300 Center mar20'>
                            <div className='mar10'>
                                <p>Sr No</p>
                            </div>
                        ...
                        <div className='w300 Center'><p>SerialNumber</p></div>
                        <div className='w300 Center'><p>Quotations</p></div>
                ...
                {data.map((elem, i) => (
                    <div key={i} className={`spaceBetween h50 ${i % 2 === 1 ? "bgWhite" : "bgLightGray "} line`}>
                        <div className='row'>
                            <div className='w300 Center fzm mar20 '><p className='mar10'>{elem.srNo}</p></div>
                            <div className='w300 Center fzm'><p>{elem.serialNumber}</p></div>
                            <div className='w300 Center fzm'><p>{elem.date}/{elem.city}</p></div>

                        </div>
                        <div className='w100 cCenter mar20'>
                            <div className='h20 w20 br5 bgLightOrange cCenter mar5 pointer' onClick={()=>navigate("oneCustomer")}>
